...
uri = "mongodb+srv://Parisan:Pan_2433865@cluster0.ipdseno.mongodb.net/?retryWrites=true&w=majority"
...
# Un pipeline permet de construire des requettes complexes.
    pipeline = []
...
#enlève les films avant la page qu'on veut
    ...
    # pipeline.extend(...) pour concaténer
...
def get_movies(filters, page, movies_per_page):
    ...
    total_num_movies = 0
    total_num_movies = db.movies.count_documents(query) - page * movies_per_page
#     if page == 0:
